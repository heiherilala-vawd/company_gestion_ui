...
import { toCrupdateCompanyMapper, toAuditUserMapper } from '../../support/mappers.ts'

export const job1Mock: Job = {
  id: 'job1_id',
  company: toCrupdateCompanyMapper(company1Mock),
...
export const job2Mock: Job = {
  id: 'job2_id',
  company: toCrupdateCompanyMapper(company2Mock),
