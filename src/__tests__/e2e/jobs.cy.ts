...
describe('E2E: Jobs', () => {
  function creatOrUpdate(isCreating: boolean) {
    ...
    cy.get('[data-testid="input-contract-signature-date"] [type="date"]')
      .clear()
      .type(<string>crupdatedData.contract_signature_date)
    cy.get('[data-testid="input-start-date"] [type="date"]')
      .clear()
      .type(<string>crupdatedData.start_date)
    cy.get('[data-testid="input-end-date"] [type="date"]')
      .clear()
      .type(<string>crupdatedData.end_date)
