...
export class IncomeApi extends runtime.BaseAPI {
     ...
     */
    async crupdateIncomesRequestOpts(requestParameters: CrupdateIncomesRequest): Promise<runtime.RequestOpts> {
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling crupdateIncomes().'
            );
        }
        ...
        let urlPath = `/users/{userId}/companies/{companyId}/jobs/{jobId}/incomes`;
     ...
     */
    async crupdateIncomesRaw(requestParameters: CrupdateIncomesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<IncomeMoney>>> {
     ...
     * Create new incomes or update existing ones
     */
    async crupdateIncomes(requestParameters: CrupdateIncomesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<IncomeMoney>> {
     ...
     */
    async deleteIncomeByIdRequestOpts(requestParameters: DeleteIncomeByIdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling deleteIncomeById().'
            );
        }
        ...
        let urlPath = `/users/{userId}/companies/{companyId}/jobs/{jobId}/incomes/{id}`;
        urlPath = urlPath.replace('{userId}', encodeURIComponent(String(requestParameters['userId'])));
        urlPath = urlPath.replace('{companyId}', encodeURIComponent(String(requestParameters['companyId'])));
        urlPath = urlPath.replace('{jobId}', encodeURIComponent(String(requestParameters['jobId'])));
     ...
     */
    async deleteIncomeByIdRaw(requestParameters: DeleteIncomeByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Delete income by identifier
     */
    async deleteIncomeById(requestParameters: DeleteIncomeByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     */
    async getIncomeByIdRequestOpts(requestParameters: GetIncomeByIdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling getIncomeById().'
            );
        }
     ...
     */
    async getIncomeByIdRaw(requestParameters: GetIncomeByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IncomeMoney>> {
     ...
     * Get income by identifier
     */
    async getIncomeById(requestParameters: GetIncomeByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IncomeMoney> {
    ...
    async getIncomesRequestOpts(requestParameters: GetIncomesRequest): Promise<runtime.RequestOpts> {
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling getIncomes().'
            );
        }
     ...
     * Get all incomes
     */
    async getIncomesRaw(requestParameters: GetIncomesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<IncomeMoney>>> {
     ...
     * Get all incomes
     */
    async getIncomes(requestParameters: GetIncomesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<IncomeMoney>> {
     ...
     */
    async getIncomesExcelRequestOpts(requestParameters: GetIncomesExcelRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling getIncomesExcel().'
            );
        }
        ...
        let urlPath = `/users/{userId}/companies/{companyId}/jobs/{jobId}/incomes/excel`;
        urlPath = urlPath.replace('{userId}', encodeURIComponent(String(requestParameters['userId'])));
        urlPath = urlPath.replace('{companyId}', encodeURIComponent(String(requestParameters['companyId'])));
        urlPath = urlPath.replace('{jobId}', encodeURIComponent(String(requestParameters['jobId'])));
     ...
     */
    async getIncomesExcelRaw(requestParameters: GetIncomesExcelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
     ...
     * Export incomes to Excel
     */
    async getIncomesExcel(requestParameters: GetIncomesExcelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
