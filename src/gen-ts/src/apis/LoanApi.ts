...
export class LoanApi extends runtime.BaseAPI {
     ...
     */
    async crupdateLoansRequestOpts(requestParameters: CrupdateLoansRequest): Promise<runtime.RequestOpts> {
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling crupdateLoans().'
            );
        }
        ...
        let urlPath = `/users/{userId}/companies/{companyId}/jobs/{jobId}/loans`;
     ...
     */
    async crupdateLoansRaw(requestParameters: CrupdateLoansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Loan>>> {
     ...
     * Create new loans or update existing ones
     */
    async crupdateLoans(requestParameters: CrupdateLoansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Loan>> {
     ...
     */
    async deleteLoanByIdRequestOpts(requestParameters: DeleteLoanByIdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling deleteLoanById().'
            );
        }
        ...
        let urlPath = `/users/{userId}/companies/{companyId}/jobs/{jobId}/loans/{id}`;
        urlPath = urlPath.replace('{userId}', encodeURIComponent(String(requestParameters['userId'])));
        urlPath = urlPath.replace('{companyId}', encodeURIComponent(String(requestParameters['companyId'])));
        urlPath = urlPath.replace('{jobId}', encodeURIComponent(String(requestParameters['jobId'])));
     ...
     */
    async deleteLoanByIdRaw(requestParameters: DeleteLoanByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Delete loan by identifier
     */
    async deleteLoanById(requestParameters: DeleteLoanByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     */
    async getLoanByIdRequestOpts(requestParameters: GetLoanByIdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling getLoanById().'
            );
        }
     ...
     */
    async getLoanByIdRaw(requestParameters: GetLoanByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Loan>> {
     ...
     * Get loan by identifier
     */
    async getLoanById(requestParameters: GetLoanByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Loan> {
    ...
    async getLoansRequestOpts(requestParameters: GetLoansRequest): Promise<runtime.RequestOpts> {
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling getLoans().'
            );
        }
     ...
     * Get all loans
     */
    async getLoansRaw(requestParameters: GetLoansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedResponse>> {
     ...
     * Get all loans
     */
    async getLoans(requestParameters: GetLoansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedResponse> {
