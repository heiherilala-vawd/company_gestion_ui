...
export class LoanApi extends runtime.BaseAPI {
     ...
     * Get all loans
     */
    async getLoansRaw(requestParameters: GetLoansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Loan>>> {
     ...
     * Get all loans
     */
    async getLoans(requestParameters: GetLoansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Loan>> {
