...
import { type EntityType, EntityTypeFromJSON, EntityTypeToJSON } from '../models/EntityType'
import { type History, HistoryFromJSON, HistoryToJSON } from '../models/History'
import {
...
export class HistoryApi extends runtime.BaseAPI {
   ...
   */
  async getHistoriesRequestOpts(
    requestParameters: GetHistoriesRequest,
