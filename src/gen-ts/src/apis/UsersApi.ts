...
export class UsersApi extends runtime.BaseAPI {
     ...
     */
    async crupdateUsersRequestOpts(requestParameters: CrupdateUsersRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
                'Required parameter "userId" was null or undefined when calling crupdateUsers().'
            );
        }
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling crupdateUsers().'
            );
        }
        ...
        let urlPath = `/users/{userId}/companies/{companyId}/users`;
     ...
     */
    async crupdateUsersRaw(requestParameters: CrupdateUsersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<User>>> {
     ...
     * Create new users or update existing users
     */
    async crupdateUsers(requestParameters: CrupdateUsersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<User>> {
    ...
    async deleteUserByIdRequestOpts(requestParameters: DeleteUserByIdRequest): Promise<runtime.RequestOpts> {
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling deleteUserById().'
            );
        }
        ...
        let urlPath = `/users/{userId}/companies/{companyId}/users/{id}`;
        urlPath = urlPath.replace('{userId}', encodeURIComponent(String(requestParameters['userId'])));
        urlPath = urlPath.replace('{companyId}', encodeURIComponent(String(requestParameters['companyId'])));
    ...
    async getUserByIdRequestOpts(requestParameters: GetUserByIdRequest): Promise<runtime.RequestOpts> {
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling getUserById().'
            );
        }
    ...
    async getUsersRequestOpts(requestParameters: GetUsersRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
                'Required parameter "userId" was null or undefined when calling getUsers().'
            );
        }
        ...
        if (requestParameters['companyId'] == null) {
            throw new runtime.RequiredError(
                'companyId',
                'Required parameter "companyId" was null or undefined when calling getUsers().'
            );
        }
