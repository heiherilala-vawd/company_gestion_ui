...
export function MaterialConsumptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): MaterialConsumption {
    if (json == null) {
        return json;
    }
    return {
...
export function MaterialConsumptionToJSONTyped(value?: MaterialConsumption | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
