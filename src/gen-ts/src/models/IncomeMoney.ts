...
export function IncomeMoneyFromJSONTyped(json: any, ignoreDiscriminator: boolean): IncomeMoney {
    ...
    return {
        ...
        'receipts': json['receipts'] == null ? undefined : ((json['receipts'] as Array<any>).map(IncomeReceiptFromJSON)),
...
export function IncomeMoneyToJSONTyped(value?: IncomeMoney | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'receipts': value['receipts'] == null ? undefined : ((value['receipts'] as Array<any>).map(IncomeReceiptToJSON)),
