...
export function EquipmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): Equipment {
    ...
    return {
        ...
        'maintenances': json['maintenances'] == null ? undefined : ((json['maintenances'] as Array<any>).map(MaintenanceFromJSON)),
    };
}
...
export function EquipmentToJSONTyped(value?: Equipment | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'maintenances': value['maintenances'] == null ? undefined : ((value['maintenances'] as Array<any>).map(MaintenanceToJSON)),
    };
}
