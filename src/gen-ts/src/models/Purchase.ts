...
export interface Purchase {
     ...
     * @memberof Purchase
     */
    source_warehouse?: CrupdateWarehouse;
    /**
     * 
     * @type {Supplier}
     * @memberof Purchase
...
export function PurchaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Purchase {
    ...
    return {
        ...
        'source_warehouse': json['source_warehouse'] == null ? undefined : CrupdateWarehouseFromJSON(json['source_warehouse']),
...
export function PurchaseToJSONTyped(value?: Purchase | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'source_warehouse': CrupdateWarehouseToJSON(value['source_warehouse']),
        ...
        'invoice_date': value['invoice_date'] == null ? value['invoice_date'] : value['invoice_date'].toISOString().substring(0,10),
