...
export function CashTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CashTransaction {
    if (json == null) {
        return json;
    }
    return {
...
export function CashTransactionToJSONTyped(value?: CashTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
