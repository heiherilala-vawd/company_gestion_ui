...
export function CompanyFixedCostFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompanyFixedCost {
    if (json == null) {
        return json;
    }
    return {
...
export function CompanyFixedCostToJSONTyped(value?: CompanyFixedCost | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
