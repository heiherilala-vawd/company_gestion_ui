...
export function LoanFromJSONTyped(json: any, ignoreDiscriminator: boolean): Loan {
    ...
    return {
        ...
        'repayments': json['repayments'] == null ? undefined : ((json['repayments'] as Array<any>).map(LoanRepaymentFromJSON)),
...
export function LoanToJSONTyped(value?: Loan | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'repayments': value['repayments'] == null ? undefined : ((value['repayments'] as Array<any>).map(LoanRepaymentToJSON)),
