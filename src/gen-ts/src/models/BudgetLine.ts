...
export function BudgetLineToJSONTyped(value?: BudgetLine | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'period_start': value['period_start'] == null ? value['period_start'] : value['period_start'].toISOString().substring(0,10),
        'period_end': value['period_end'] == null ? value['period_end'] : value['period_end'].toISOString().substring(0,10),
