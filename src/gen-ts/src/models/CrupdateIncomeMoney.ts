...
export function instanceOfCrupdateIncomeMoney(value: object): value is CrupdateIncomeMoney {
    if (!('source_organization' in value) || value['source_organization'] === undefined) return false;
    if (!('job_id' in value) || value['job_id'] === undefined) return false;
    if (!('income_type_id' in value) || value['income_type_id'] === undefined) return false;
    return true;
}
...
export function CrupdateIncomeMoneyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CrupdateIncomeMoney {
    ...
    return {
        ...
        'source_organization': json['source_organization'],
        ...
        'job_id': json['job_id'],
        'income_type_id': json['income_type_id'],
    };
}
