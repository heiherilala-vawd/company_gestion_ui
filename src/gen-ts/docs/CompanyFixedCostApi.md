...
> Array&lt;CompanyFixedCost&gt; crupdateCompanyFixedCosts(userId, companyId, crupdateCompanyFixedCost)
...
> deleteCompanyFixedCostById(userId, companyId, id)
...
> CompanyFixedCost getCompanyFixedCostById(userId, companyId, id)
