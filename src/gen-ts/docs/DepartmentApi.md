...
> Array&lt;Department&gt; crupdateDepartments(userId, companyId, crupdateDepartment)
...
> deleteDepartmentById(userId, companyId, id)
...
> Department getDepartmentById(userId, companyId, id)
