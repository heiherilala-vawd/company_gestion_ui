...
> Array&lt;OtherExpense&gt; crupdateOtherExpenses(compId, jobId, userId, crupdateOtherExpense)
...
> deleteOtherExpenseById(compId, jobId, userId, id)
...
> OtherExpense getOtherExpenseById(compId, jobId, userId, id)
...
> Array&lt;OtherExpense&gt; getOtherExpenses(compId, jobId, userId, page, pageSize, description)
