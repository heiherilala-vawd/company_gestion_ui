...
|------------- | ------------- | -------------|
| [**crupdateMaterialWarehouses**](MaterialWarehouseApi.md#crupdatematerialwarehouses) | **PUT** /users/{userId}/companies/{companyId}/material_warehouses | Create or update material warehouse stock |
| [**getMaterialWarehouses**](MaterialWarehouseApi.md#getmaterialwarehouses) | **GET** /users/{userId}/companies/{companyId}/material_warehouses | Get all material warehouse stock records |



## crupdateMaterialWarehouses

> Array&lt;MaterialWarehouseInfo&gt; crupdateMaterialWarehouses(userId, companyId, crupdateMaterialWarehouse)
...
> PaginatedResponse getMaterialWarehouses(userId, companyId, page, pageSize, materialId, warehouseId, notArrived)
