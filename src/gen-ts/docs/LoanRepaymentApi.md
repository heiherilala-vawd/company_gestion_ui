...
|------------- | ------------- | -------------|
| [**crupdateLoanRepayments**](LoanRepaymentApi.md#crupdateloanrepayments) | **PUT** /companies/{comp_id}/job/{job_id}/user/{user_id}/loans_repayment | Create new loan repayments or update existing ones |
| [**deleteLoanRepaymentById**](LoanRepaymentApi.md#deleteloanrepaymentbyid) | **DELETE** /companies/{comp_id}/job/{job_id}/user/{user_id}/loans_repayment/{id} | Delete loan repayment by identifier |
| [**getLoanRepaymentById**](LoanRepaymentApi.md#getloanrepaymentbyid) | **GET** /companies/{comp_id}/job/{job_id}/user/{user_id}/loans_repayment/{id} | Get loan repayment by identifier |
| [**getLoanRepayments**](LoanRepaymentApi.md#getloanrepayments) | **GET** /companies/{comp_id}/job/{job_id}/user/{user_id}/loans_repayment | Get all loan repayments |



## crupdateLoanRepayments

> Array&lt;LoanRepayment&gt; crupdateLoanRepayments(compId, jobId, userId, crupdateLoanRepayment, loanId)
...
> deleteLoanRepaymentById(compId, jobId, userId, id, loanId)
...
> LoanRepayment getLoanRepaymentById(compId, jobId, userId, id, loanId)
