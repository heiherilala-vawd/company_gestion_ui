...
> Array&lt;EmployeePayment&gt; crupdateEmployeePayments(userId, companyId, jobId, crupdateEmployeePayment)
...
> deleteEmployeePaymentById(userId, companyId, jobId, id)
...
> EmployeePayment getEmployeePaymentById(userId, companyId, jobId, id)
...
> Array&lt;EmployeePayment&gt; getEmployeePayments(userId, companyId, jobId, page, pageSize, userIds, paymentDescription, paymentType)
