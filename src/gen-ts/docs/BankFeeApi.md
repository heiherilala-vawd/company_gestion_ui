...
|------------- | ------------- | -------------|
| [**crupdateBankFees**](BankFeeApi.md#crupdatebankfees) | **PUT** /users/{userId}/companies/{companyId}/jobs/{jobId}/bank_fees | Create new bank fees or update existing ones |
| [**deleteBankFeeById**](BankFeeApi.md#deletebankfeebyid) | **DELETE** /users/{userId}/companies/{companyId}/jobs/{jobId}/bank_fees/{id} | Delete bank fee by identifier |
| [**getBankFeeById**](BankFeeApi.md#getbankfeebyid) | **GET** /users/{userId}/companies/{companyId}/jobs/{jobId}/bank_fees/{id} | Get bank fee by identifier |
| [**getBankFees**](BankFeeApi.md#getbankfees) | **GET** /users/{userId}/companies/{companyId}/jobs/{jobId}/bank_fees | Get all bank fees |



## crupdateBankFees

> Array&lt;BankFee&gt; crupdateBankFees(userId, companyId, jobId, crupdateBankFee)
...
async function example() {
  ...
  const body = {
    ...
    crupdateBankFee: [{"id":"bank_001","expense":{"id":"exp_001","amount":5000,"job_id":"job_001"},"bank_name":"BNP Paribas","description":"Frais de virement international révisés"}],
...
> deleteBankFeeById(userId, companyId, jobId, id)
...
> BankFee getBankFeeById(userId, companyId, jobId, id)
...
> PaginatedResponse getBankFees(userId, companyId, jobId, page, pageSize, bankName, description)
