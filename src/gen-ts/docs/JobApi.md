...
| -------------------------------------------------------------- | ------------------------------------------------------------------- | --------------------------------------- |
| [**assignUserToJob**](JobApi.md#assignusertojob)               | **PUT** /users/{userId}/companies/{companyId}/jobs/{jobId}/users    | Assign a user to a job                  |
...
| [**getJobResponsibleUsers**](JobApi.md#getjobresponsibleusers) | **GET** /users/{userId}/companies/{companyId}/jobs/{jobId}/users    | Get responsible users for a job         |
| [**getJobs**](JobApi.md#getjobs)                               | **GET** /users/{userId}/companies/{companyId}/jobs                  | Get all jobs                            |
| [**unassignUserFromJob**](JobApi.md#unassignuserfromjob)       | **DELETE** /users/{userId}/companies/{companyId}/jobs/{jobId}/users | Unassign a user from a job              |
...
> Array&lt;User&gt; getJobResponsibleUsers(userId, companyId, jobId)
...
> Array&lt;Job&gt; getJobs(userId, companyId, page, pageSize, status, description)
