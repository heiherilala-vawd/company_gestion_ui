...
|------------- | ------------- | -------------|
| [**assignUserToJob**](JobApi.md#assignusertojob) | **PUT** /users/{userId}/companies/{companyId}/jobs/{jobId}/assigned_users | Assign a user to a job |
| [**crupdateJobs**](JobApi.md#crupdatejobs) | **PUT** /users/{userId}/companies/{companyId}/jobs | Create new jobs or update existing jobs |
| [**deleteJobById**](JobApi.md#deletejobbyid) | **DELETE** /users/{userId}/companies/{companyId}/jobs/{id} | Delete a job by identifier |
| [**getJobById**](JobApi.md#getjobbyid) | **GET** /users/{userId}/companies/{companyId}/jobs/{id} | Get job by identifier |
| [**getJobResponsibleUsers**](JobApi.md#getjobresponsibleusers) | **GET** /users/{userId}/companies/{companyId}/jobs/{jobId}/assigned_users | Get responsible users for a job |
| [**getJobs**](JobApi.md#getjobs) | **GET** /users/{userId}/companies/{companyId}/jobs | Get all jobs |
| [**unassignUserFromJob**](JobApi.md#unassignuserfromjob) | **DELETE** /users/{userId}/companies/{companyId}/jobs/{jobId}/assigned_users | Unassign a user from a job |



## assignUserToJob

> assignUserToJob(userId, companyId, jobId)
...
> Array&lt;Job&gt; crupdateJobs(userId, companyId, crupdateJob)
...
> deleteJobById(userId, companyId, id)
...
> Job getJobById(userId, companyId, id)
...
> PaginatedResponse getJobResponsibleUsers(userId, companyId, jobId, page, pageSize)
...
> PaginatedResponse getJobs(userId, companyId, page, pageSize, status, description)
...
> unassignUserFromJob(userId, companyId, jobId)
