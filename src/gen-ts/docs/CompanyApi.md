...
|------------- | ------------- | -------------|
| [**crupdateCompanies**](CompanyApi.md#crupdatecompanies) | **PUT** /users/{userId}/companies | Create new companies or update existing companies |
| [**deleteCompanyById**](CompanyApi.md#deletecompanybyid) | **DELETE** /users/{userId}/companies/{companyId} | Delete a company by identifier |
| [**getCompanies**](CompanyApi.md#getcompanies) | **GET** /users/{userId}/companies | Get all companies for a user |
| [**getCompanyById**](CompanyApi.md#getcompanybyid) | **GET** /users/{userId}/companies/{companyId} | Get company by identifier |



## crupdateCompanies

> Array&lt;Company&gt; crupdateCompanies(userId, crupdateCompany)
...
> deleteCompanyById(userId, companyId)
...
> PaginatedResponse getCompanies(userId, page, pageSize, name, rib, description, companyType)
...
> Company getCompanyById(userId, companyId)
