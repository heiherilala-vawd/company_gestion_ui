...
| ----------------------------------------------------------- | ---------------------------------------------- | ------------------------------------- |
| [**crupdateSuppliers**](SupplierApi.md#crupdatesuppliers)   | **PUT** /companies/{comp_id}/suppliers         | Create or update suppliers (crupdate) |
| [**deleteSupplierById**](SupplierApi.md#deletesupplierbyid) | **DELETE** /companies/{comp_id}/suppliers/{id} | Delete a supplier                     |
| [**getSupplierById**](SupplierApi.md#getsupplierbyid)       | **GET** /companies/{comp_id}/suppliers/{id}    | Get supplier by ID                    |
| [**getSuppliers**](SupplierApi.md#getsuppliers)             | **GET** /companies/{comp_id}/suppliers         | Get all suppliers for a company       |

## crupdateSuppliers

> Array&lt;Supplier&gt; crupdateSuppliers(compId, crupdateSupplier)
...
> Supplier getSupplierById(compId, id)
...
> Array&lt;Supplier&gt; getSuppliers(compId)
