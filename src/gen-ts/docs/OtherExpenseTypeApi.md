...
async function example() {
  ...
  const body = {
    ...
    crupdateOtherExpenseType: [{"id":"other_exp_type_001","name":"Logistique","description":"Frais logistiques et transport","company_id":"comp_btp001","comment":"Type principal"},{"name":"Maintenance","description":"Frais de maintenance et réparation","company_id":"comp_btp001","comment":"Nouveau type"}],
...
> PaginatedResponse getOtherExpenseTypes(userId, companyId)
