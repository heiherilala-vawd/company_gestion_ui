...
> PaginatedResponse getHistories(page, pageSize, userId, entityType, entityId, dateFrom, dateTo)
...
| **entityType** | `EntityType` | Filter by entity type | [Optional] [Defaults to `undefined`] [Enum: USER, COMPANY, JOB, WAREHOUSE, EQUIPMENT, MATERIAL, INCOMEMONEY, INCOMETYPE, EXPENSEMONEY, EMPLOYEE_PAYMENT, TRAVEL_EXPENSE, TRAVELPEOPLE, TRAVELMATERIALS, TRAVELEQUIPMENT, PURCHASE, BANK_FEE, OTHER_EXPENSE, TEAM, OTHEREXPENSETYPE, COMPANYFIXEDCOST, LOAN, LOANREPAYMENT, INCOMERECEIPT, LEAVETYPE, EMPLOYEELEAVECONFIG, LEAVE, TASK, TASKASSIGNMENT, TASKSCHEDULE, DEPARTMENT, CASHACCOUNT, CASHTRANSACTION, BUDGETLINE, EQUIPMENTUSAGE, MATERIALCONSUMPTION, ORGANIZATION, PURCHASEORDER, PURCHASEORDERLINE, SUPPLIER, MAINTENANCESCHEDULE, NOTIFICATION, CAR] |
