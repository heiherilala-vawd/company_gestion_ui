...
| **entityType** | `EntityType` | Filter by entity type                            | [Optional] [Defaults to `undefined`] [Enum: USER, COMPANY, JOB, WAREHOUSE, EQUIPMENT, MATERIAL, INCOMEMONEY, INCOMETYPE, EXPENSEMONEY, EMPLOYEE_PAYMENT, TRAVEL_EXPENSE, TRAVELPEOPLE, TRAVELMATERIALS, TRAVELEQUIPMENT, PURCHASE, BANK_FEE, OTHER_EXPENSE, TEAM] |
