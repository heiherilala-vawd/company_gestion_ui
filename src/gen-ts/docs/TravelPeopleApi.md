...
> Array&lt;TravelPeople&gt; crupdateTravelPeople(compId, jobId, userId, crupdateTravelPeople)
...
> deleteTravelPeopleById(compId, jobId, userId, id)
...
> Array&lt;TravelPeople&gt; getTravelPeople(compId, jobId, userId, page, pageSize, travelId, userId2, arrivalLocation, arrivalDateMin, arrivalDateMax, notArrived)
...
> TravelPeople getTravelPeopleById(compId, jobId, userId, id)
