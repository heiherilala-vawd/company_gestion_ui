...
> TimeSeriesResponse getBudgetTimeSeries(userId, companyId, dateFrom, dateTo, granularity)
...
> TimeSeriesResponse getCashFlowTimeSeries(userId, companyId, dateFrom, dateTo, granularity)
...
> EquipmentDashboardResponse getEquipmentDashboard(userId, companyId, jobId, dateFrom, dateTo)
...
> EquipmentBreakdownResponse getEquipmentDashboardBreakdown(userId, companyId, jobId, dateFrom, dateTo)
...
> EquipmentSummaryResponse getEquipmentDashboardSummary(userId, companyId, jobId, dateFrom, dateTo)
...
> TimeSeriesResponse getExpenseBreakdownTimeSeries(userId, companyId, jobId, dateFrom, dateTo, granularity)
...
> TimeSeriesResponse getExpensesTimeSeries(userId, companyId, jobId, dateFrom, dateTo, granularity)
...
> HrDashboardResponse getHrDashboard(userId, companyId, jobId, dateFrom, dateTo)
...
> HrBreakdownResponse getHrDashboardBreakdown(userId, companyId, jobId, dateFrom, dateTo)
...
> HrSummaryResponse getHrDashboardSummary(userId, companyId, jobId, dateFrom, dateTo)
...
> MaterialDashboardResponse getMaterialDashboard(userId, companyId, jobId, dateFrom, dateTo)
...
> MaterialBreakdownResponse getMaterialDashboardBreakdown(userId, companyId, jobId, dateFrom, dateTo)
...
> MaterialSummaryResponse getMaterialDashboardSummary(userId, companyId, jobId, dateFrom, dateTo)
...
> MonetaryDashboardResponse getMonetaryDashboard(userId, companyId, jobId, dateFrom, dateTo)
...
> MonetaryBreakdownResponse getMonetaryDashboardBreakdown(userId, companyId, jobId, dateFrom, dateTo)
...
> MonetarySummaryResponse getMonetaryDashboardSummary(userId, companyId, jobId, dateFrom, dateTo)
...
> TimeSeriesResponse getProfitTimeSeries(userId, companyId, jobId, dateFrom, dateTo, granularity)
...
> TimeSeriesResponse getReceivablesTimeSeries(userId, companyId, jobId, dateFrom, dateTo, granularity)
...
> TimeSeriesResponse getRevenueTimeSeries(userId, companyId, jobId, dateFrom, dateTo, granularity)
...
> YearlyReport usersUserIdCompaniesCompanyIdYearlyReportGet(userId, companyId, year, page, pageSize)
