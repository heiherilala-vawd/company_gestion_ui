...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- | -------------------------------------------------- |
| [**createPurchaseOperation**](PurchaseOperationApi.md#createpurchaseoperation) | **POST** /users/{userId}/companies/{companyId}/jobs/{jobId}/purchase_operations | Register a purchase operation with optional travel |

## createPurchaseOperation

> Array&lt;Purchase&gt; createPurchaseOperation(userId, companyId, jobId, purchaseOperationRequest)
...
```ts
import { Configuration, PurchaseOperationApi } from 'api-client'
...
async function example() {
  ...
  const body = {
    ...
    purchaseOperationRequest: {
      equipment_lines: [
        {
          equipment: { id: 'eq_003', name: 'Bétonnière 500L' },
          expense_id: 'exp_001',
      ...
      material_lines: [
        {
          material: { id: 'mat_004', name: 'Acier à béton HA12' },
          expense_id: 'exp_001',
